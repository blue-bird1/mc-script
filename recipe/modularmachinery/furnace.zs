...
builder2.addEnergyPerTickInput(800);
...
RecipeBuilder.newBuilder("ingot_meteorite_forged", "furnace", 100).addItemInputs([
    <hbm:ingot_meteorite> * 1,
    <ore:coalCoke>*1
]).addEnergyPerTickInput(8000).addFluidInput(<liquid:oxygen> *1000).addFluidInput(<liquid:hydrogen> * 1000).addItemOutput(<hbm:ingot_meteorite_forged>* 1).build();
